...
Наш сервис будет иметь следующие возможности:
- Система входа и регистрации <br>
- система обмена сообщениями <br>
- Автоматическое резюме-генератор <br>
- Загрузка фотографий, лайков, комментариев и данных пользователей <br>
- Комментарии <br>
- Раздел, о пользователе, настройки и фотографиии <br>
