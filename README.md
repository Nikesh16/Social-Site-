...
<div align="center">
<img width="50%" height = "300px" src="https://github.com/Nikesh16/Social-Site-/blob/59902e81b357eb148aff461f85c7b59d30097476/Pictures/Comparison%20Table.png" alt="cover" />
</div>
<h3>Вывод </h3>
Наши сайты после сравнения будут иметь следующие вещи:
- Система входа и регистрации
- система обмена сообщениями
- Автоматическое резюме-генератор резюме
- Загрузка фотографий, лайков, комментариев и дат пользователей
- Комментарии
- О разделе пользователя, настройках и фотографиях
